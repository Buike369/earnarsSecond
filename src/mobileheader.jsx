 ...
 <button className={open1?"menu bg":"opened bg"} onClick={ open1?seOpen : seOpen4} aria-label="Main Menu">
      ...
      <div className="Mobile_menu1">
        ...
        <div className="IfeY">
          ...
          <li className="bgstyle"><div className="derr" onClick={dropdown}><span className="derpm"><span className="mackP">*</span> * Markets</span> <span>{showMe?<FontAwesomeIcon icon={faAngleUp} className="PlusIcon plusIcon2" />:<FontAwesomeIcon icon={faAngleDown} className="PlusIcon plusIcon2" />}</span></div>
          {showMe? 
            <div className="Forexmm">
             ...
             <li className="bgstyle"><div className="derr" onClick={dropdown2}><span className="derpm"><span className="mackP">*</span> * Tipster</span> <span>{showMe4?<FontAwesomeIcon icon={faAngleUp} className="PlusIcon plusIcon2" />:<FontAwesomeIcon icon={faAngleDown} className="PlusIcon plusIcon2" />}</span></div>
          {showMe4? 
            <div className="Forexmm">
                      <a  className="fit" href="/sport" onClick={mark}> <span className="mackP1">*</span>Become a Tipster</a>
                      <a  className="fit" href="/forex" onClick={mark}><span className="mackP1">*</span> Find a Tipster</a>
                      <a  className="fit" href="cryptocurrency" onClick={mark}> <span className="mackP1">*</span> All Tips </a>
                     
            </div>:""}
            </li>
          <li className="bgstyle"><a href="/premium" onClick={mark} className="derpm"> <span className="mackP">*</span> * Premium Predictions</a></li>
