          ...
          <div className="sportPa">
            <div className="affiliateImage" >
                    <div className="grace">
                       ...
                       <p  className="weAre4">With Upto <span className="withUpto">75% acurrancy<span>.</span></span></p>
                       <p className='everyWhere'>Buy low and sell high</p>
                       <div className='football'>BinaryCent, deriv, iq option etc.</div>
                    </div>
                     <div className="grace">
                   
                      <img src="/img/affiliate-banner.png" className="gracePic" alt="affiliate_banner"/>
                     </div>
...
<div className='sportsPageColorBg'>       
      ...
      {currentUser ? " " :  <div style={{display:"flex",justifyContent:"center",alignItems:"center"}}><Link to="/login" className="ifi"> <button className="NowUpSign" >SIGN UP NOW</button></Link> </div>}  
        ...
        <div className="outcomeBeen1">
            <div className='whatIs'><img src="/img/techny.gif" alt=""  className="BinaryImage"/></div>
...
only two outcomes – win or lose. </div>
        </div>
